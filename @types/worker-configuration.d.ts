/* eslint-disable */
// Generated by Wrangler by running `wrangler types @types/worker-configuration.d.ts` (hash: 43f58802a0e568ef0518e0a41bfcba61)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "JWT_SECRET" | "CRYPTO_HASH_KEY" | "COOKIE_SECRET">> {}
}
