/* eslint-disable */
// Generated by Wrangler by running `wrangler types @types/worker-configuration.d.ts` (hash: fb6a8e4ff09de92c6fa3e4668cc01b67)
// Runtime types generated with workerd@1.20260401.1 2025-04-16 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../server/src/index");
		durableNamespaces: "Storage" | "Connection";
	}
	interface Env {
		SDB: D1Database;
		ASSETS: Fetcher;
		...
		APPLE_CLIENT_ID: "com.locapos.web.auth";
		APPLE_TEAM_ID: "J3LZEFNZVJ";
		APPLE_KEY_ID: "Z4KJY953RN";
		X_CLIENT_ID: "Qjg4c3R2NXdRYUtGQUhqSTVvVnk6MTpjaQ";
		...
		MSA_CLIENT_SECRET: string;
		X_CLIENT_SECRET: string;
		STORAGE_DO: DurableObjectNamespace<import("../server/src/index").Storage>;
		CONNECTION_DO: DurableObjectNamespace<import("../server/src/index").Connection>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "REDIRECT_URI_BASE" | "GITHUB_CLIENT_ID" | "GOOGLE_CLIENT_ID" | "MSA_CLIENT_ID" | "LINE_CHANNEL_ID" | "APPLE_CLIENT_ID" | "APPLE_TEAM_ID" | "APPLE_KEY_ID" | "X_CLIENT_ID" | "APPLE_PRIVATE_KEY" | "COOKIE_SECRET" | "CRYPTO_HASH_KEY" | "GITHUB_CLIENT_SECRET" | "GOOGLE_CLIENT_SECRET" | "GOOGLE_MAPS_API_KEY" | "JWT_SECRET" | "LINE_CHANNEL_SECRET" | "MSA_CLIENT_SECRET" | "X_CLIENT_SECRET">> {}
}
